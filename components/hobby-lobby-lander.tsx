...
const HOBBY = "#EF4416"
const HOBBY_DEEP = "#2A0C04"
const HOBBY_BRIGHT = "#FF8A5C"
const INK = "#111213"
...
function CTAButton({
  ...
  return (
    <a
      ...
      style={dark ? { backgroundColor: HOBBY, color: "#FFFFFF" } : { backgroundColor: "#FFFFFF", color: INK }}
    >
      {children}
      <svg
        viewBox="0 0 24 24"
  ...
  return (
    <div className="relative grid grid-cols-[3rem_1fr] md:grid-cols-[1fr_3.5rem_1fr] gap-x-4 md:gap-x-8 items-center pb-6 md:pb-8 last:pb-0">
      <div
        ...
        aria-hidden="true"
      >
        <span className="font-black text-6xl lg:text-7xl leading-none select-none" style={{ color: "#FBD8CB" }}>
          0{index + 1}
        </span>
      </div>
      ...
      <div className="order-1 md:order-2 flex justify-center self-start md:self-center pt-1 md:pt-0">
        <div
          ...
          style={{
            backgroundColor: HOBBY,
            borderColor: HOBBY,
            color: "#FFFFFF",
            boxShadow: "0 8px 22px rgba(239,68,22,.34)",
          }}
        >
          {index + 1}
        </div>
      ...
      >
        <div className={`flex items-start gap-4 ${leftSide ? "md:flex-row-reverse md:text-right" : ""}`}>
          <div
            ...
            style={{ backgroundColor: "#FDE7E0" }}
          >
            <Icon d={step.icon} color={HOBBY} className="w-6 h-6" />
          </div>
...
export default function HobbyLobbyRewardLander() {
  ...
  return (
    <div className="min-h-screen bg-white antialiased overflow-x-hidden font-sans" style={{ color: INK }}>
      <style>{`
        ...
        .card-shine { position: absolute; inset: 0; pointer-events: none; background: linear-gradient(115deg, transparent 35%, rgba(239,68,22,0.06) 47%, rgba(255,255,255,0.55) 52%, transparent 65%); background-size: 260% 100%; animation: cardShine 7s ease-in-out infinite; }
        ...
        .cat-spark { position: absolute; top: 16px; right: 18px; color: #EF4416; animation: sparkTwinkle 3.4s ease-in-out infinite; }
      ...
      <section
        ...
        style={{ background: `linear-gradient(170deg, ${HOBBY_BRIGHT} 0%, ${HOBBY} 45%, ${HOBBY_DEEP} 100%)` }}
      >
        ...
        <div className="relative mx-auto max-w-3xl px-6 pt-12 pb-20 md:pt-20 md:pb-24 text-center">
          <div className="text-white">
            ...
            <h1 className="mt-6 font-black tracking-tight leading-[1.05] text-[1.68rem] min-[344px]:text-[1.86rem] min-[376px]:text-[2.04rem] min-[408px]:text-[2.22rem] min-[440px]:text-[2.4rem] min-[472px]:text-[2.59rem] min-[504px]:text-[2.77rem] min-[536px]:text-[2.95rem] min-[568px]:text-[3.13rem] min-[600px]:text-[3.31rem] min-[632px]:text-[3.49rem] min-[664px]:text-[3.68rem] min-[696px]:text-[3.86rem] min-[728px]:text-[4.09rem] text-balance">
      ...
      <section className="relative overflow-hidden bg-white">
        <div className="relative mx-auto max-w-5xl px-6 py-16 md:py-20">
          <div className="text-center">
            <div className="text-sm font-semibold tracking-widest uppercase" style={{ color: HOBBY }}>
              How it works
            </div>
              ...
              <div key={f.q} className="rounded-2xl bg-white border border-gray-200 shadow-sm">
                ...
                >
                  ...
                  <span
                    ...
                    style={{ backgroundColor: openFaq === i ? HOBBY : "#F2F3F5" }}
                  >
                    <svg
                      viewBox="0 0 20 20"
      ...
      <section
        className="relative overflow-hidden"
        style={{ background: `linear-gradient(170deg, ${HOBBY_BRIGHT} 0%, ${HOBBY} 50%, ${HOBBY_DEEP} 100%)` }}
      >
        {[
          { l: "6%", s: 5, d: 7, delay: 0 },
        ...
        <div className="orb w-96 h-96 -top-24 -left-24" style={{ backgroundColor: "#FBC7B4", opacity: 0.35 }} />
        <div
          className="orb w-80 h-80 -bottom-24 -right-16"
          style={{ backgroundColor: "#2A0C04", animationDelay: "-5s" }}
        />
